...
Typically avoid naive bayes because assumes predictors are independent and all quantitative predictors are normally distributed.
...
Since the 80% credible interval contains 0, we can't feel confident that age is impactful.
...
But we also have predictors like walk_score which are the same for each neighborhood but impact the understanding
